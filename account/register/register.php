...
if ($stmt = $con->prepare("INSERT INTO " . config_table_name_accounts . " (username, id, password, displayname, account_version, sorting, gradesystem) VALUES (?, ?, ?, ?, 3, 'average', 'noten')")) {
